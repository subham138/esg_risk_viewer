...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2023 at 02:21 PM
...
--
-- Table structure for table `md_cal_act`
--

CREATE TABLE `md_cal_act` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `md_cal_act`
--

INSERT INTO `md_cal_act` (`id`, `type_id`, `act_name`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, 1, 'Gaseous fuels', 'Super Admin', '2023-11-14 11:13:29', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `md_cal_emi_type`
--

CREATE TABLE `md_cal_emi_type` (
  `id` int(11) NOT NULL,
  `type_id` int(11) NOT NULL,
...
--
-- Dumping data for table `md_cal_emi_type`
--

INSERT INTO `md_cal_emi_type` (`id`, `type_id`, `act_id`, `emi_name`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, 1, 1, 'Butane', 'Super Admin', '2023-11-14 11:21:05', 'Super Admin', '2023-11-14 11:24:31');

-- --------------------------------------------------------

--
-- Table structure for table `md_cal_emi_val`
--

CREATE TABLE `md_cal_emi_val` (
  `id` int(11) NOT NULL,
  `type_id` int(11) NOT NULL,
  `act_id` int(11) NOT NULL,
  `emi_type_id` int(11) NOT NULL,
  `unit_id` int(11) NOT NULL,
  `co_val` float(10,2) NOT NULL,
  `created_by` varchar(50) DEFAULT NULL,
  `created_dt` datetime DEFAULT NULL,
  `modified_by` varchar(50) DEFAULT NULL,
  `modified_dt` datetime DEFAULT NULL
...
--
-- Table structure for table `md_cal_type`
--

CREATE TABLE `md_cal_type` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `md_cal_type`
--

INSERT INTO `md_cal_type` (`id`, `type_name`, `type`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, 'Fuels', 'Fuel', 'Super Admin', '2023-11-14 11:01:38', 'Super Admin', '2023-11-14 11:13:11');
...
(1, 0, 'Apparel, Accessories & Footwear', 'admin', '2023-08-24 00:00:00'),
...
(1, 'Afghanistan', 'admin', NULL),
(2, 'Åland Islands', 'admin', NULL),
(3, 'Albania', 'admin', NULL),
(4, 'Algeria', 'admin', NULL),
(5, 'American Samoa', 'admin', NULL),
(6, 'AndorrA', 'admin', NULL),
(7, 'Angola', 'admin', NULL),
(8, 'Anguilla', 'admin', NULL),
(9, 'Antarctica', 'admin', NULL),
(10, 'Antigua and Barbuda', 'admin', NULL),
(11, 'Argentina', 'admin', NULL),
(12, 'Armenia', 'admin', NULL),
(13, 'Aruba', 'admin', NULL),
(14, 'Australia', 'admin', NULL),
(15, 'Austria', 'admin', NULL),
(16, 'Azerbaijan', 'admin', NULL),
(17, 'Bahamas', 'admin', NULL),
(18, 'Bahrain', 'admin', NULL),
(19, 'Bangladesh', 'admin', NULL),
(20, 'Barbados', 'admin', NULL),
(21, 'Belarus', 'admin', NULL),
(22, 'Belgium', 'admin', NULL),
(23, 'Belize', 'admin', NULL),
(24, 'Benin', 'admin', NULL),
(25, 'Bermuda', 'admin', NULL),
(26, 'Bhutan', 'admin', NULL),
(27, 'Bolivia', 'admin', NULL),
(28, 'Bosnia and Herzegovina', 'admin', NULL),
(29, 'Botswana', 'admin', NULL),
(30, 'Bouvet Island', 'admin', NULL),
(31, 'Brazil', 'admin', NULL),
(32, 'British Indian Ocean Territory', 'admin', NULL),
(33, 'Brunei Darussalam', 'admin', NULL),
(34, 'Bulgaria', 'admin', NULL),
(35, 'Burkina Faso', 'admin', NULL),
(36, 'Burundi', 'admin', NULL),
(37, 'Cambodia', 'admin', NULL),
(38, 'Cameroon', 'admin', NULL),
(39, 'Canada', 'admin', NULL),
(40, 'Cape Verde', 'admin', NULL),
(41, 'Cayman Islands', 'admin', NULL),
(42, 'Central African Republic', 'admin', NULL),
(43, 'Chad', 'admin', NULL),
(44, 'Chile', 'admin', NULL),
(45, 'China', 'admin', NULL),
(46, 'Christmas Island', 'admin', NULL),
(47, 'Cocos (Keeling) Islands', 'admin', NULL),
(48, 'Colombia', 'admin', NULL),
(49, 'Comoros', 'admin', NULL),
(50, 'Congo', 'admin', NULL),
(51, 'Congo, The Democratic Republic of the', 'admin', NULL),
(52, 'Cook Islands', 'admin', NULL),
(53, 'Costa Rica', 'admin', NULL),
(54, 'Croatia', 'admin', NULL),
(55, 'Cuba', 'admin', NULL),
(56, 'Cyprus', 'admin', NULL),
(57, 'Czech Republic', 'admin', NULL),
(58, 'Denmark', 'admin', NULL),
(59, 'Djibouti', 'admin', NULL),
(60, 'Dominica', 'admin', NULL),
(61, 'Dominican Republic', 'admin', NULL),
(62, 'Ecuador', 'admin', NULL),
(63, 'Egypt', 'admin', NULL),
(64, 'El Salvador', 'admin', NULL),
(65, 'Equatorial Guinea', 'admin', NULL),
(66, 'Eritrea', 'admin', NULL),
(67, 'Estonia', 'admin', NULL),
(68, 'Ethiopia', 'admin', NULL),
(69, 'Falkland Islands (Malvinas)', 'admin', NULL),
(70, 'Faroe Islands', 'admin', NULL),
(71, 'Fiji', 'admin', NULL),
(72, 'Finland', 'admin', NULL),
(73, 'France', 'admin', NULL),
(74, 'French Guiana', 'admin', NULL),
(75, 'French Polynesia', 'admin', NULL),
(76, 'French Southern Territories', 'admin', NULL),
(77, 'Gabon', 'admin', NULL),
(78, 'Gambia', 'admin', NULL),
(79, 'Georgia', 'admin', NULL),
(80, 'Germany', 'admin', NULL),
(81, 'Ghana', 'admin', NULL),
(82, 'Gibraltar', 'admin', NULL),
(83, 'Greece', 'admin', NULL),
(84, 'Greenland', 'admin', NULL),
(85, 'Grenada', 'admin', NULL),
(86, 'Guadeloupe', 'admin', NULL),
(87, 'Guam', 'admin', NULL),
(88, 'Guatemala', 'admin', NULL),
(89, 'Guernsey', 'admin', NULL),
(90, 'Guinea', 'admin', NULL),
(91, 'Guinea-Bissau', 'admin', NULL),
(92, 'Guyana', 'admin', NULL),
(93, 'Haiti', 'admin', NULL),
(94, 'Heard Island and Mcdonald Islands', 'admin', NULL),
(95, 'Holy See (Vatican City State)', 'admin', NULL),
(96, 'Honduras', 'admin', NULL),
(97, 'Hong Kong', 'admin', NULL),
(98, 'Hungary', 'admin', NULL),
(99, 'Iceland', 'admin', NULL),
(100, 'India', 'admin', NULL),
(101, 'Indonesia', 'admin', NULL),
(102, 'Iran, Islamic Republic Of', 'admin', NULL),
(103, 'Iraq', 'admin', NULL),
(104, 'Ireland', 'admin', NULL),
(105, 'Isle of Man', 'admin', NULL),
(106, 'Israel', 'admin', NULL),
(107, 'Italy', 'admin', NULL),
(108, 'Jamaica', 'admin', NULL),
(109, 'Japan', 'admin', NULL),
(110, 'Jersey', 'admin', NULL),
(111, 'Jordan', 'admin', NULL),
(112, 'Kazakhstan', 'admin', NULL),
(113, 'Kenya', 'admin', NULL),
(114, 'Kiribati', 'admin', NULL),
(115, 'Korea, Republic of', 'admin', NULL),
(116, 'Kuwait', 'admin', NULL),
(117, 'Kyrgyzstan', 'admin', NULL),
(118, 'Latvia', 'admin', NULL),
(119, 'Lebanon', 'admin', NULL),
(120, 'Lesotho', 'admin', NULL),
(121, 'Liberia', 'admin', NULL),
(122, 'Libyan Arab Jamahiriya', 'admin', NULL),
(123, 'Liechtenstein', 'admin', NULL),
(124, 'Lithuania', 'admin', NULL),
(125, 'Luxembourg', 'admin', NULL),
(126, 'Macao', 'admin', NULL),
(127, 'Macedonia, The Former Yugoslav Republic of', 'admin', NULL),
(128, 'Madagascar', 'admin', NULL),
(129, 'Malawi', 'admin', NULL),
(130, 'Malaysia', 'admin', NULL),
(131, 'Maldives', 'admin', NULL),
(132, 'Mali', 'admin', NULL),
(133, 'Malta', 'admin', NULL),
(134, 'Marshall Islands', 'admin', NULL),
(135, 'Martinique', 'admin', NULL),
(136, 'Mauritania', 'admin', NULL),
(137, 'Mauritius', 'admin', NULL),
(138, 'Mayotte', 'admin', NULL),
(139, 'Mexico', 'admin', NULL),
(140, 'Micronesia, Federated States of', 'admin', NULL),
(141, 'Moldova, Republic of', 'admin', NULL),
(142, 'Monaco', 'admin', NULL),
(143, 'Mongolia', 'admin', NULL),
(144, 'Montserrat', 'admin', NULL),
(145, 'Morocco', 'admin', NULL),
(146, 'Mozambique', 'admin', NULL),
(147, 'Myanmar', 'admin', NULL),
(148, 'Namibia', 'admin', NULL),
(149, 'Nauru', 'admin', NULL),
(150, 'Nepal', 'admin', NULL),
(151, 'Netherlands', 'admin', NULL),
(152, 'Netherlands Antilles', 'admin', NULL),
(153, 'New Caledonia', 'admin', NULL),
(154, 'New Zealand', 'admin', NULL),
(155, 'Nicaragua', 'admin', NULL),
(156, 'Niger', 'admin', NULL),
(157, 'Nigeria', 'admin', NULL),
(158, 'Niue', 'admin', NULL),
(159, 'Norfolk Island', 'admin', NULL),
(160, 'Northern Mariana Islands', 'admin', NULL),
(161, 'Norway', 'admin', NULL),
(162, 'Oman', 'admin', NULL),
(163, 'Pakistan', 'admin', NULL),
(164, 'Palau', 'admin', NULL),
(165, 'Palestinian Territory, Occupied', 'admin', NULL),
(166, 'Panama', 'admin', NULL),
(167, 'Papua New Guinea', 'admin', NULL),
(168, 'Paraguay', 'admin', NULL),
(169, 'Peru', 'admin', NULL),
(170, 'Philippines', 'admin', NULL),
(171, 'Pitcairn', 'admin', NULL),
(172, 'Poland', 'admin', NULL),
(173, 'Portugal', 'admin', NULL),
(174, 'Puerto Rico', 'admin', NULL),
(175, 'Qatar', 'admin', NULL),
(176, 'Reunion', 'admin', NULL),
(177, 'Romania', 'admin', NULL),
(178, 'Russian Federation', 'admin', NULL),
(179, 'Rwanda', 'admin', NULL),
(180, 'Saint Helena', 'admin', NULL),
(181, 'Saint Kitts and Nevis', 'admin', NULL),
(182, 'Saint Lucia', 'admin', NULL),
(183, 'Saint Pierre and Miquelon', 'admin', NULL),
(184, 'Saint Vincent and the Grenadines', 'admin', NULL),
(185, 'Samoa', 'admin', NULL),
(186, 'San Marino', 'admin', NULL),
(187, 'Sao Tome and Principe', 'admin', NULL),
(188, 'Saudi Arabia', 'admin', NULL),
(189, 'Senegal', 'admin', NULL),
(190, 'Serbia and Montenegro', 'admin', NULL),
(191, 'Seychelles', 'admin', NULL),
(192, 'Sierra Leone', 'admin', NULL),
(193, 'Singapore', 'admin', NULL),
(194, 'Slovakia', 'admin', NULL),
(195, 'Slovenia', 'admin', NULL),
(196, 'Solomon Islands', 'admin', NULL),
(197, 'Somalia', 'admin', NULL),
(198, 'South Africa', 'admin', NULL),
(199, 'South Georgia and the South Sandwich Islands', 'admin', NULL),
(200, 'Spain', 'admin', NULL),
(201, 'Sri Lanka', 'admin', NULL),
(202, 'Sudan', 'admin', NULL),
(203, 'Suriname', 'admin', NULL),
(204, 'Svalbard and Jan Mayen', 'admin', NULL),
(205, 'Swaziland', 'admin', NULL),
(206, 'Sweden', 'admin', NULL),
(207, 'Switzerland', 'admin', NULL),
(208, 'Syrian Arab Republic', 'admin', NULL),
(209, 'Taiwan, Province of China', 'admin', NULL),
(210, 'Tajikistan', 'admin', NULL),
(211, 'Tanzania, United Republic of', 'admin', NULL),
(212, 'Thailand', 'admin', NULL),
(213, 'Timor-Leste', 'admin', NULL),
(214, 'Togo', 'admin', NULL),
(215, 'Tokelau', 'admin', NULL),
(216, 'Tonga', 'admin', NULL),
(217, 'Trinidad and Tobago', 'admin', NULL),
(218, 'Tunisia', 'admin', NULL),
(219, 'Turkey', 'admin', NULL),
(220, 'Turkmenistan', 'admin', NULL),
(221, 'Turks and Caicos Islands', 'admin', NULL),
(222, 'Tuvalu', 'admin', NULL),
(223, 'Uganda', 'admin', NULL),
(224, 'Ukraine', 'admin', NULL),
(225, 'United Arab Emirates', 'admin', NULL),
(226, 'United Kingdom', 'admin', NULL),
(227, 'United States', 'admin', NULL),
(228, 'United States Minor Outlying Islands', 'admin', NULL),
(229, 'Uruguay', 'admin', NULL),
(230, 'Uzbekistan', 'admin', NULL),
(231, 'Vanuatu', 'admin', NULL),
(232, 'Venezuela', 'admin', NULL),
(233, 'Viet Nam', 'admin', NULL),
(234, 'Virgin Islands, British', 'admin', NULL),
(235, 'Virgin Islands, U.S.', 'admin', NULL),
(236, 'Wallis and Futuna', 'admin', NULL),
(237, 'Western Sahara', 'admin', NULL),
(238, 'Yemen', 'admin', NULL),
(239, 'Zambia', 'admin', NULL),
(240, 'Zimbabw', 'admin', NULL);
...
(27, 0, 'undefined', NULL, NULL),
(28, 6, 'Lala Topic', NULL, NULL),
(29, 0, 'undefined', NULL, NULL);
...
INSERT INTO `md_unit` (`id`, `unit_name`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, 'Tonnes', 'Super Admin', '2023-11-20 17:11:44', 'Super Admin', '2023-11-20 17:12:21');
...
(1, 0, 'Super Admin', 'admin@gmail.com', '$2b$10$IBqFiOnGUiHZpBnXGnMBwu6CB2IbcUBHLvpC2jdRsSx7QIXaATTei', 'S', 'Y', 'admin', '2023-08-18 15:44:12', 'Admin', '2023-10-06 11:18:13', NULL),
...
(4, 1, 'Amit Mondal', 'amit@gmail.com', '$2b$10$PQUP.sDkASFaxomtU1nmj.F6TJ0Oo76tufUBG3qI9YY92d/W9WWmm', 'E', 'Y', 'Subham', '2023-09-15 12:21:26', 'Subham', '2023-10-03 13:22:53', NULL),
(5, 1, 'Subham Samanta', 'subham@gmail.com', '$2b$10$.BFFtlnRqoRo9aB34FU4MemqBpjjJfPe5OW20mP/vG8aPJH438E1C', 'V', 'Y', 'Subham', '2023-09-15 15:56:49', 'Subham', '2023-09-26 18:46:13', NULL),
...
(11, 3, 'S s', 's@s.com', '$2b$10$dZnVSO/ghzgJeep7P9Fomu09VTx7K.uVFrhK.ur05aBu0IaKbtJKe', 'C', 'Y', 'Super Admin', '2023-10-06 12:13:44', NULL, NULL, NULL);
...
CREATE TABLE `td_client` (
  ...
  `plan_type` enum('B','S','P','N') DEFAULT NULL COMMENT 'B-> Basic; S-> Standard; P-> Premium',
  `pay_flag` enum('Y','N') DEFAULT NULL,
  `plan_active_dt` datetime DEFAULT NULL,
  `plan_deactive_dt` datetime DEFAULT NULL,
  `created_by` varchar(50) DEFAULT NULL,
  `created_dt` datetime DEFAULT NULL,
  `modified_by` varchar(50) DEFAULT NULL,
  `modified_dt` datetime DEFAULT NULL
...
INSERT INTO `td_client` (`id`, `entry_dt`, `client_name`, `plan_type`, `pay_flag`, `plan_active_dt`, `plan_deactive_dt`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, '2023-09-14 14:20:00', 'Synergic Softek Solutions', 'B', 'Y', '2023-10-18 15:18:52', '2023-10-12 15:18:52', 'admin', NULL, 'Subham', '2023-10-18 15:18:52'),
(3, '2023-10-06 12:13:44', 'SSS', 'N', NULL, NULL, NULL, 'Super Admin', '2023-10-06 12:13:44', NULL, NULL);
...
(1, 2023, 9, 58, 10, '9_58_10_2023.json', 'admin', '2023-09-08 14:07:52', 'admin', '2023-11-10 17:32:45'),
(2, 2023, 9, 58, 11, '9_58_11_2023.json', 'admin', '2023-09-14 11:44:49', NULL, NULL),
(5, 2023, 9, 58, 12, '9_58_12_2023.json', 'admin', '2023-10-27 16:37:47', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `td_img_galary`
--

CREATE TABLE `td_img_galary` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `td_project` (
  ...
  `business_act` text DEFAULT NULL,
  `location_busi_act` text DEFAULT NULL,
  `created_by` varchar(50) DEFAULT NULL,
  `created_dt` datetime DEFAULT NULL,
  `modified_by` varchar(50) DEFAULT NULL,
  `modified_dt` datetime DEFAULT NULL
...
INSERT INTO `td_project` (`id`, `client_id`, `project_name`, `last_access`, `last_accessed_by`, `sec_id`, `ind_id`, `business_act`, `location_busi_act`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, 1, 'Test Project', '2023-10-04 14:13:35', 'Subham', 9, 58, '85.1 Pre-primary education,85.32 Technical and vocational secondary education', 'Australia,Canada', 'Subham', '2023-09-15 15:57:54', 'Subham', '2023-10-04 14:13:35'),
(2, 1, 'ESG', '2023-10-27 17:11:12', 'Subham', 9, 58, '85.1 Pre-primary education', 'Brazil', 'Subham', '2023-10-18 16:08:30', 'Subham', '2023-10-27 17:11:12'),
(3, 1, 'LALALA', '2023-10-26 16:17:00', 'Subham', 9, 58, '85.1 Pre-primary education,85.31 General secondary education,85.41 Post-secondary non-tertiary education', 'Australia,Canada', 'Subham', '2023-10-26 16:16:23', 'Subham', '2023-10-26 16:17:00'),
(4, 1, 'Test Project 1', '2023-10-27 17:14:41', 'Subham', 1, 3, '13.92 Manufacture of made-up textile articles, except apparel,16.29 Manufacture of other products of wood; manufacture of articles of cork, straw and plaiting mat', 'Asean,Australia', 'Subham', '2023-10-27 17:12:24', 'Subham', '2023-10-27 17:14:41');

-- --------------------------------------------------------

--
-- Table structure for table `td_project_work`
--

CREATE TABLE `td_project_work` (
  `id` int(11) NOT NULL,
  `sec_id` int(11) NOT NULL,
  `ind_id` int(11) NOT NULL,
  `top_id` int(11) NOT NULL,
...
--
-- Dumping data for table `td_project_work`
--

INSERT INTO `td_project_work` (`id`, `sec_id`, `ind_id`, `top_id`, `project_id`, `article_code`, `article`, `user_id`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, 9, 58, 10, 1, 'SV-ED-230a.1', '<p>Access your <strong>ESG </strong>Information <strong>System</strong>, <strong>Manage </strong>and <em>Report Disclosure Topic</em> (Account <u>Upgrade Required</u>)</p>\n\n<p>SV-ED-230a.1</p>\n', 3, 'Subham', '2023-09-26 18:40:32', NULL, NULL),
(2, 9, 58, 10, 1, 'SV-ED-230a.2', '<p>test 2&nbsp;SV-ED-230a.2</p>\n', 3, 'Subham', '2023-10-18 17:24:56', NULL, NULL),
(3, 9, 58, 10, 1, 'SV-ED-230a.3', '<p>TEst 3&nbsp;SV-ED-230a.3</p>\n', 3, 'Subham', '2023-10-18 17:25:06', NULL, NULL),
(4, 9, 58, 10, 3, 'SV-ED-230a.1', '<p>asdasdasd</p>\n', 3, 'Subham', '2023-10-26 16:18:24', NULL, NULL),
(5, 9, 58, 11, 1, 'SV-ED-260a.1', '<p>Customer Welfare</p>\n\n<p>SV-ED-260a.1</p>\n', 3, 'Subham', '2023-11-10 15:20:46', NULL, NULL),
(6, 9, 58, 0, 1, 'Test', '<p>TEst taeasteatsetasetatseasdasd</p>\n', 3, 'Subham', '2023-11-10 15:21:45', NULL, NULL);
...
CREATE TABLE `td_support_log` (
  ...
  `tkt_status` enum('P','S','R') NOT NULL DEFAULT 'P' COMMENT 'P-> Pending; S-> Solved; R-> Rejected',
  `created_by` varchar(50) DEFAULT NULL,
  `created_dt` datetime DEFAULT NULL,
  `modified_by` varchar(50) DEFAULT NULL,
  `modified_dt` datetime DEFAULT NULL
...
INSERT INTO `td_support_log` (`id`, `tkt_no`, `tkt_date`, `client_id`, `issue`, `issued_by`, `resolved_by`, `resolve_dt`, `remarks`, `tkt_status`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, 'C1/1/20231030', '2023-10-30 18:26:26', 1, 'Issue 1 Update', 3, '1', '2023-10-31 14:03:36', 'Resolved', 'S', 'Subham', '2023-10-30 18:26:26', 'Super Admin', '2023-10-31 14:03:36');
...
CREATE TABLE `td_sus_dis_top_met` (
  ...
  `top_id` int(11) NOT NULL,
  `sl_no` int(11) NOT NULL,
  `ind_agn` varchar(100) DEFAULT NULL,
...
INSERT INTO `td_sus_dis_top_met` (`id`, `sec_id`, `ind_id`, `top_id`, `sl_no`, `ind_agn`, `metric`, `catg`, `unit`, `code`, `words`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
(1, 9, 58, 10, 1, 'dS1', 'Description of approach to identifying and addressing data security risks', 'Discussion and Analysis', 'n/a', 'SV-ED-230a.1', 'Many, Account, ESG, Make', 'admin', '2023-09-08 16:44:11', 'admin', '2023-11-20 15:09:34'),
(2, 9, 58, 10, 2, 'ds2', 'Description of policies and practices relating to collection, usage, and retention of student information', 'Discussion and Analysis', 'n/a', 'SV-ED-230a.2', 'Super, Admin', 'admin', '2023-09-08 16:44:11', 'admin', '2023-11-20 15:09:34'),
(3, 9, 58, 11, 1, 'cw1', 'Graduation rate', 'Quantitative', 'Percentage (%)', 'SV-ED-260a.1', 'null', 'admin', '2023-09-08 16:44:11', 'admin', '2023-11-20 15:09:34'),
(4, 9, 58, 11, 2, 'cw2', 'On-time completion rate', 'Quantitative', 'Percentage (%)', 'SV-ED-260a.2', 'null', 'admin', '2023-09-08 16:44:11', 'admin', '2023-11-20 15:09:34'),
(5, 9, 58, 12, 1, 'sp1', 'Description of policies to assure disclosure of key performance statistics to prospective students in advance of collecting any fees and discussion of outcomes', 'Discussion and Analysis', 'n/a', 'SV-ED-270a.1', 'null', 'admin', '2023-09-08 16:44:11', 'admin', '2023-11-20 15:09:34');
...
(1, 1, 1, 4, 'Subham', '2023-10-03 13:55:27', 'Subham', '2023-10-03 13:58:36'),
(4, 1, 2, 4, 'Subham', '2023-10-18 16:08:30', NULL, NULL),
(5, 1, 3, 4, 'Subham', '2023-10-26 16:16:23', NULL, NULL),
(6, 1, 4, 5, 'Subham', '2023-10-27 17:12:24', NULL, NULL);
...
--
-- Indexes for table `md_cal_act`
--
ALTER TABLE `md_cal_act`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `md_cal_emi_type`
--
ALTER TABLE `md_cal_emi_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `md_cal_emi_val`
--
ALTER TABLE `md_cal_emi_val`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `md_cal_type`
--
ALTER TABLE `md_cal_type`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `td_img_galary`
--
ALTER TABLE `td_img_galary`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `td_project_work`
--
ALTER TABLE `td_project_work`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `md_cal_act`
--
ALTER TABLE `md_cal_act`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `md_cal_emi_type`
--
ALTER TABLE `md_cal_emi_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `md_cal_emi_val`
--
ALTER TABLE `md_cal_emi_val`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `md_cal_type`
--
ALTER TABLE `md_cal_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `td_img_galary`
--
ALTER TABLE `td_img_galary`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `td_project_work`
--
ALTER TABLE `td_project_work`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
