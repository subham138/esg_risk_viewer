...
module.exports = {
    ...
    getGhgCalList: (proj_id, client_id, period) => {
        return new Promise(async (resolve, reject) => {
            var calSel = `a.id, a.client_id, a.scope, a.project_id, a.quest_id, a.sl_no, a.sec_id, a.act_id, a.emi_type_id, a.repo_period, a.repo_month, a.repo_mode_label, a.emi_type_unit_id, a.cal_val, a.emi_fact_val, a.co_val, c.act_name, d.emi_name, b.sec_id cal_sec_id, e.sec_name cal_sec_name, b.sequence, b.parent_id, b.sub_parent_id, (SELECT quest_ans FROM td_ghg_quest f WHERE f.client_id = a.client_id AND f.scope = a.scope AND f.project_id = a.project_id AND f.pro_sl_no = a.sl_no AND f.proj_year = a.repo_period AND f.quest_type = 'I' AND f.quest_seq = '1.1.1' LIMIT 1 ) quest_ans`,
