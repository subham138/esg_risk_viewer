    ...
    saveClientData: (data, user) => {
        return new Promise(async (resolve, reject) => {
            ...
            var table_name = 'td_client',
                ...
                values = `('${datetime}', '${data.client_name}', 'N', '${data.ai_tag_tool_flag}', '${data.ghg_emi_flag}', '${data.ifrs_flag}', '${data.ifrs_fr_flag}', '${data.esrs_flag}', '${data.esrs_fr_flag}', '${data.esrs_vsme_flag}', '${data.esrs_vsme_fr_flag}', '${data.gri_flag}', '${data.gri_fr_flag}', '${data.cal_lang_flag}', '${user}', '${datetime}')`,
                whr = data.id > 0 ? `id = ${data.id}` : null,
                flag = data.id > 0 ? 1 : 0;
