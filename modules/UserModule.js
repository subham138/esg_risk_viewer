    ...
    saveClientData: (data, user) => {
        return new Promise(async (resolve, reject) => {
            ...
            var table_name = 'td_client',
                ...
                values = `('${datetime}', '${data.client_name}', 'N', '${data.ai_tag_tool_flag ? data.ai_tag_tool_flag : "N"}', '${data.ghg_emi_flag ? data.ghg_emi_flag : "N"}', '${data.ifrs_flag ? data.ifrs_flag : 'N'}', '${data.ifrs_fr_flag ? data.ifrs_fr_flag : "N"}', '${data.esrs_flag ? data.esrs_flag : "N"}', '${data.esrs_fr_flag ? data.esrs_fr_flag : "N"}', '${data.esrs_vsme_flag ? data.esrs_vsme_flag : "N"}', '${data.esrs_vsme_fr_flag ? data.esrs_vsme_fr_flag : "N"}', '${data.gri_flag ? data.gri_flag : "N"}', '${data.gri_fr_flag ? data.gri_fr_flag : "N"}', '${data.cal_lang_flag ? data.cal_lang_flag : "N"}', '${user}', '${datetime}')`,
                whr = data.id > 0 ? `id = ${data.id}` : null,
                flag = data.id > 0 ? 1 : 0;
